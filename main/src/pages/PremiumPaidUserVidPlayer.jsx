...
const PremiumPaidUserVidPlayer = ({ headerImage }) => {
  return (
    <>
      ...
      <section className="section section--head section--head-fixed section--gradient section--details-bg">
        <div
          ...
          data-bg="/src/assets/img/details.jpg"
        ></div>
            ...
            <div className="row">
              ...
              <div className="col-12 col-xl-8">
                <video
                  ...
                  crossOrigin
                  playsInline
                  poster="./Content/2.jpg"
                  id="player"
                >
                  <source
                    src="https://drive.google.com/file/d/13Or55OHFuf7incqmm8leMKprgvAQ8AmG/preview"
                    type="video/mp4 "
                    size="576"
                  />
                  <source
                    src="https://res.cloudinary.com/dyyzhaxvv/video/upload/v1735214045/apdmuu8uquxtafhff9ka.mp4"
                    type="video/mp4"
                    size="720"
                  />
                  <source
                  ...
                  <a href="./Content/123.mp4" download>
                    Download
                  </a>
                </video>
                  ...
                  <div className="section__carousel-wrap">
                    <div className="section__series owl-carousel" id="series">
                      <div className="series">
                        <a href="details.html" className="series__cover">
                          <img src="/src/assets/img/series/1.jpg" alt="" />
                          <span>
                            <svg
                              width="22"
                              height="22"
                        ...
                        <h3 className="series__title">
                          <a href="details.html.html">1st series</a>
                        </h3>
                      </div>

                      <div className="series">
                        <a href="details.html" className="series__cover">
                          <img src="/src/assets/img/series/2.jpg" alt="" />
                          <span>
                            <svg
                              width="22"
                              height="22"
                        ...
                        <h3 className="series__title">
                          <a href="details.html">2nd series</a>
                        </h3>
                      </div>

                      <div className="series">
                        <a href="details.html" className="series__cover">
                          <img src="/src/assets/img/series/3.jpg" alt="" />
                          <span>
                            <svg
                              width="22"
                              height="22"
                        ...
                        <h3 className="series__title">
                          <a href="details.html">3rd series</a>
                        </h3>
                      </div>

                      <div className="series">
                        <a href="details.html" className="series__cover">
                          <img src="/src/assets/img/series/4.jpg" alt="" />
                          <span>
                            <svg
                              width="22"
                              height="22"
                        ...
                        <h3 className="series__title">
                          <a href="details.html">4th series</a>
                        </h3>
                      </div>

                      <div className="series">
                        <a href="details.html" className="series__cover">
                          <img src="/src/assets/img/series/5.jpg" alt="" />
                          <span>
                            <svg
                              width="22"
                              height="22"
                        ...
                        <h3 className="series__title">
                          <a href="details.html">5th series</a>
                        </h3>
                      </div>

                      <div className="series">
                        <a href="details.html" className="series__cover">
                          <img src="/src/assets/img/series/6.jpg" alt="" />
                          <span>
                            <svg
                              width="22"
                              height="22"
                        ...
                        <h3 className="series__title">
                          <a href="details.html">6th series</a>
                        </h3>
                      </div>
                    </div>
...
PremiumPaidUserVidPlayer.propTypes = {
  headerImage: PropTypes.string.isRequired,
};

export default PremiumPaidUserVidPlayer;
