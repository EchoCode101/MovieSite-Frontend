...
const CategoryDetailed = ({ headerImage }) => {
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-xl-6">
              <h1 className="section__title section__title--head">Category</h1>
            </div>
      ...
      <div className="catalog catalog--page catalog--list">
        <div className="container">
          <div className="row">
            <div className="col-12">
              <div className="catalog__nav catalog__nav--relative">
