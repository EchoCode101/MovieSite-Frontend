    ...
    <>
          ...
          <div className="row row--grid">
            ...
            <div className="col-12 col-lg-4">
              <div className="step">
                ...
                <h3 className="step__title">Enjoy Punjabi Dub</h3>
                <p className="step__text">
                  It to make a type specimen book. It has survived not only five
                  centuries, but also the leap into electronic typesetting
                </p>
      ...
      <section className="section section--pb0 section--gradient">
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h2 className="section__title">Subscribe features</h2>
            </div>
          </div>
          ...
          <div className="row row--grid">
            ...
            <div className="col-12 col-md-6 col-lg-4 col-xl-3">
              <div className="feature">
                ...
                <h3 className="feature__title">Choose your Plan</h3>
                <p className="feature__text">
                  t to make a type specimen book. It has survived not only five
                  centuries, but also the leap into electronic typesetting,
            ...
            <div className="col-12 col-md-6 col-lg-4 col-xl-3">
              <div className="feature feature--prelast">
                <span className="feature__icon">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
