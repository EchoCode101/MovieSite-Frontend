              ...
              <div className="dashbox">
                <div className="dashbox__title">
                  ...
                  <div className="dashbox__wrap">
                    ...
                    <a className="dashbox__more" href="catalog">
                      View All
                    </a>
                  </div>
                </div>
              ...
              <div className="dashbox">
                <div className="dashbox__title">
                  ...
                  <div className="dashbox__wrap">
                    ...
                    <a className="dashbox__more" href="users">
                      View All
                    </a>
                  </div>
                </div>
              ...
              <div className="dashbox">
                <div className="dashbox__title">
                  ...
                  <div className="dashbox__wrap">
                    ...
                    <a className="dashbox__more" href="reviews">
                      View All
                    </a>
                  </div>
                </div>
...
// now these routes are all set and working :"<Route path="/signin" element={<Signin />} />
//         <Route path="/signup" element={<Signup />} />
//         <Route path="/forgot" element={<Forgot />} />
//         <Route path="/reset-password/:token" element={<ResetPassword />} />"
// i think its time to move on to the next step
// :"<>
...
// lets first deal with the "dashboard" and make reuseably html components for better raect implementation
// code index.html: "
// convert to react give it to me the code!

// give me five  components each time and when i am done i will tell you to move on and ten provide next remaining components and when there are no more left tell me then we willl move on to the next page!
